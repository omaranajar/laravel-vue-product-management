    ...
    <div class="container">
      ...
      <form>
        ...
        <div class="field password-field">
          ...
          <span v-if="validationErrors.password" class="error password-error">
            <i class="bx bx-error-circle error-icon"></i>
            <p class="error-text">
        ...
        <div class="sign_up">
          Not a member? <RouterLink to="/register">Signup now</RouterLink>
        </div>
      </form>
    </div>
  </div>
  ...
  methods: {
    login() {
      ...
      if (this.isValidate()) {
        this.isLoading = true;
        axios
          .post("login", this.model.credentials)
          .then((res) => {
          ...
          .catch((error) => {
            ...
            if (error.response.status == 422) {
              ...
              this.validationErrors.password = error.response.data.message;
            } else {
    ...
    isValidate() {
      if (this.isSubmitted) {
        ...
        if (!this.model.credentials.email.match(emaiPattern)) {
        ...
        if (!this.model.credentials.password.match(passPattern)) {
          this.validationErrors.password =
