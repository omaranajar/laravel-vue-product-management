<template>
  <div class="center-container mt-4">
    <div class="container my-4">
      <img
        v-if="errorMsg == 'NOT FOUND'"
        src="../../assets/images/error-404.png"
        class="w-100"
      />
      <header v-if="errorMsg != 'NOT FOUND'">Edit Product</header>
      <form v-if="errorMsg != 'NOT FOUND'" enctype="multipart/form-data">
          ...
          <div class="avatar-upload">
            ...
            <div class="avatar-preview">
              <div
                ...
                id="imagePreview"
                :style="{ backgroundImage: 'url(' + model.product.image + ')' }"
              ></div>
              <div
                v-else
                id="imagePreview"
        ...
        <div class="input-field button">
          <!-- <input @click.prevent="updateProduct" type="submit" value="Update" /> -->
          <button
  ...
  methods: {
      ...
      axios
        ...
        .then((res) => {
          ...
          this.model.product = {
            ...
            image: `${backendStorageUrl}${productData.image}`,
    ...
    updateProduct() {
      ...
      if (this.isValidate()) {
        this.isLoading = true;
        axios
          .post("products/" + this.$route.params.id, this.model.product, {
            headers: {
